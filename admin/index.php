...
<head>
  ...
  <!-- gijgo datepicker -->
  <link rel="stylesheet" href="../vendor/gijgo/css/gijgo.min.css" type="text/css" />
...
<body>
            ...
            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
              ...
              <li class="nav-item dropdown">
                ...
                <ul aria-labelledby="languages" class="dropdown-menu">
                  <li>
                    <a rel="nofollow" href="#" class="dropdown-item">
                      <img src="../img/flags/16/DE.png" alt="English" class="mr-2">German</a>
                  </li>
                  <li>
                    <a rel="nofollow" href="#" class="dropdown-item">
                      <img src="../img/flags/16/FR.png" alt="English" class="mr-2">French </a>
                  </li>
                </ul>
              </li>
              <!-- Logout    -->
    ...
    <div class="page-content d-flex align-items-stretch">
      ...
      <nav class="side-navbar">
        ...
        <ul class="list-unstyled">
          ...
          <li class="active">
            <a href="#dropBarang" aria-expanded="false" data-toggle="collapse">
              <i class="fa fa-bar-chart"></i>Pendataan Barang </a>
            <ul id="dropBarang" class="collapse list-unstyled ">
              <li class="active">
                <a href="?page=barang_add">Tambah Barang</a>
              </li>
              <li>
                <a href="#">Page</a>
              </li>
        ...
        <ul class="list-unstyled">
          <li>
            <a href="?page=admin_add">
              <i class="icon-flask"></i>data Admin </a>
          </li>
          <li>
            <a href="#">
  ...
  <script src="inc/js/function.js?n=0"></script>
  <script src="inc/js/app.js?n=1"></script>
</body>
